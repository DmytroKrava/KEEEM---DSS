...
export const Filtration = ({
  ...
  return (
    <div ref={ref} className={`filtration-form ${sideLeftFilterOpened?'':'transLeft'}`} data-content="qwe12">
      <div>
        <div>
          <b>Обрана карта:</b>
      ...
      <Pseudo
        ...
        parentDataContent="Вікно фільтрації. Користувач може обрати експертів та задачі, які потрібно відобразити на карті."
      />
    </div>
  );
};
